    ...
    return (
        <div className="banner-card-main-bg shadow absolute -bottom-60 left-1/2 max-w-2xl rounded-xl backdrop-blur-md">
            <div className="banner-card-main-block p-8 text-center">
                <h4 className="text-2xl font-bold singlePageCardDescription">TECHNOLOGY</h4>
                <p className="text-5xl leading-[78px] font-bold my-11 singlePageCardDescription">Technology taking over century blah blah</p>
